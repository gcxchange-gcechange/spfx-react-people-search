define([], function () {
  return {
    ...
    SearchPropsDesc:
      " F Enter the properties separated by comma to be used for search",
    ClearTextSearchPropsLabel: " F Properties whose values are not replaced",
    ClearTextSearchPropsDesc:
      "F Enter the properties separated by comma to be sent as it is without replacing space with '+'",

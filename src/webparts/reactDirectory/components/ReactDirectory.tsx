...
export default class ReactDirectory extends React.Component<IReactDirectoryProps, IReactDirectoryState> {
   ...
   *
   *
   * @param {IReactDirectoryProps} prevProps
   * @param {IReactDirectoryState} prevState
   * @memberof Directory
   */
  public async componentDidUpdate(
    prevProps: IReactDirectoryProps,
    prevState: IReactDirectoryState
  ) {
    if (
   ...
   * @memberof Directory
   */
  public render(): React.ReactElement<IReactDirectoryProps> {
